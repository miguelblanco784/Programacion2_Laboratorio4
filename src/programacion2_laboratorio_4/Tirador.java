...
public class Tirador extends Jugador {
    ...
    public Tirador(int tiro3, int tiro2, int manejobalon, String nombre, String apodo, int numero, String favfutbol, String favbaloncesto, String jugadorfav, boolean mayoredad, String nacimiento, int numestrellas) {
