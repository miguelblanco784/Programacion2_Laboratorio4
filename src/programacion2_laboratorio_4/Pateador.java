...
public class Pateador extends Jugador {
    ...
    public Pateador(int habpateadora, int fuerza, int habregateadora, String nombre, String apodo, int numero, String favfutbol, String favbaloncesto, String jugadorfav, boolean mayoredad, String nacimiento, int numestrellas) {
